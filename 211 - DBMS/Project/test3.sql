...
CREATE TABLE Buyer_bid (id int(10) NOT NULL AUTO_INCREMENT, rank_id int(10) NOT NULL, bidWeight int(10) NOT NULL, bidPrize_perUnit int(10) NOT NULL, Buyerb_username varchar(25) NOT NULL, Bid_roombid_id int(11) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE AfteBid_rankSale (Buyer_bidid int(10) NOT NULL, notify_id int(10) NOT NULL AUTO_INCREMENT, StartTime time NOT NULL, EndTime time NOT NULL, restWeight int(10) NOT NULL, lowestPrize_perUnit int(10) NOT NULL, text varchar(255) NOT NULL, PRIMARY KEY (notify_id));
...
CREATE TABLE Bid_room (bid_id int(11) NOT NULL AUTO_INCREMENT, totalWeight int(11) NOT NULL, lowest_bidWeight int(11) NOT NULL, lowestPrize_perUnit int(11) NOT NULL, bid_start int(11) NOT NULL, bid_end int(11) NOT NULL, Productp_id int(10) NOT NULL, PRIMARY KEY (bid_id));
