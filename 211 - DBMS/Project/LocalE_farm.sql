...
CREATE TABLE Product (p_id int(10) NOT NULL AUTO_INCREMENT, productName varchar(25) NOT NULL, productImage varchar(255) NOT NULL, Weight int(10) NOT NULL, Price_perUnit int(10) NOT NULL, Unit varchar(10) NOT NULL, Added_date date NOT NULL, BidDate date, BidTime time, Bid_weight int(11), farmerf_username varchar(25) NOT NULL, PRIMARY KEY (p_id));
CREATE TABLE Buyer_bid (id int(10) NOT NULL AUTO_INCREMENT, rank_id int(10) NOT NULL, b_bidWeight int(10) NOT NULL, b_bidPrice_perUnit int(10) NOT NULL, Buyerb_username varchar(25) NOT NULL, Bid_roombid_id int(11) NOT NULL, farmer_profit int(11) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Buyer_bid_Buyer (Buyer_bidid int(10) NOT NULL, Buyerb_username varchar(25) NOT NULL, ProductName varchar(25) NOT NULL, totalWeight int(11) NOT NULL, totalCost int(11) NOT NULL, text varchar(255) NOT NULL, PRIMARY KEY (Buyer_bidid, Buyerb_username));
...
ALTER TABLE Buyer_bid_Buyer ADD INDEX FKBuyer_bid_858554 (Buyer_bidid), ADD CONSTRAINT FKBuyer_bid_858554 FOREIGN KEY (Buyer_bidid) REFERENCES Buyer_bid (id);
ALTER TABLE Buyer_bid_Buyer ADD INDEX FKBuyer_bid_821334 (Buyerb_username), ADD CONSTRAINT FKBuyer_bid_821334 FOREIGN KEY (Buyerb_username) REFERENCES Buyer (b_username);
